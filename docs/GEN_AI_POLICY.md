...
- Copilot alike real-time code assistants are OK to use, because you can operate in a Human-In-The-Loop manner, inspect and intervene what LLMs do. But don't *just keep pressing the "Tab" key to accept suggestions until there's no red wavy lines[^1].*
...
- Advanced "agents" like Cursor, Claude Code, Windsurf and Codeium, *which are very fashionable recently*, are strictly prohibited. We've seen many times that these tools show **very severe hallucination**, especially in complicated tasks.
